...
\documentclass[
    ...
    TitleEng        = {{Design and Implementation of a Logistics Domain LLM-based Intelligent Operation Analysis Assistant}}
]{zjuthesis}

%% Multi-line title for cover page
\titletwolines{基于物流领域大语言模型的}{智能运营分析助手设计与实现}
\titleengthreelines{Design and Implementation of a Logistics}{Domain LLM-based Intelligent Operation}{Analysis Assistant}
