...
\documentclass[
    ...
    % Thesis Info
    ClassNumber     = TP391,                     % 按中国图书分类法，学位办网上可查
    ...
    % Title
    Title           = 基于物流领域大语言模型的智能运营分析助手设计与实现,
    TitleEng        = {{Design and Implementation of an Intelligent Operation Analysis Assistant Based on a Logistics Domain Large Language Model}}
]{zjuthesis}

%% Multi-line title for cover page
\titletwolines{基于物流领域大语言模型的}{智能运营分析助手设计与实现}
\titleengtwolines{Design and Implementation of an Intelligent Operation Analysis Assistant}{Based on a Logistics Domain Large Language Model}
